...
<div class="a-toolbar">
  ...
  <a class="a-btn" href="/admin/notes/new">New note</a>
</div>
<?php if (!$posts): ?>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a class="a-rowlink" href="/admin/notes/edit?id=<?= (int) $p['id'] ?>"><?= esc($p['title']) ?></a><br>
      ...
      <td style="text-align:right">
        <form method="post" action="/admin/notes/delete" onsubmit="return confirm('Delete this note permanently?')">
          <?= csrf_field() ?>
