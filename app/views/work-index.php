...
<section class="hero hero--inner">
  <div class="wrap">
    ...
    <?php $icon = 'work'; require __DIR__ . '/page-icon.php'; ?>
  </div>
</section>
      ...
      <a class="work-card" href="/work/supporting-local-music">
        <div class="work-card-media">
          <img src="/assets/img/halloween-2026/facebook.webp"
               ...
               sizes="(min-width: 1180px) 526px, (min-width: 681px) 50vw, 100vw" alt="The Halloween cover-show poster art: a hooded skull figure beside a sunken cabin in cold blue-green woods" width="3840" height="2010" loading="lazy">
        </div>
        <div class="work-card-body">
