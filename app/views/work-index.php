    ...
    <div class="work-grid">
      <a class="work-card work-card--lead" href="/work/restreak">
        <div class="work-card-media work-card-media--restreak">
          <img src="/assets/img/restreak/restreak-home-light.webp"
               srcset="/assets/img/restreak/restreak-home-light-900w.webp 900w, /assets/img/restreak/restreak-home-light-1800w.webp 1800w, /assets/img/restreak/restreak-home-light.webp 2880w"
               sizes="(min-width: 1180px) 1084px, 100vw" alt="Restreak's daily game screen" width="2880" height="1800" loading="lazy">
        </div>
      ...
      <a class="work-card" href="/work/fma-social">
        <div class="work-card-media">
          <img src="/assets/img/fma-social/fma-three-brands.webp"
               ...
               sizes="(min-width: 1180px) 526px, (min-width: 681px) 50vw, 100vw" alt="The same social template across the FMA, Fabricator, and SparkForce brands" width="2328" height="760" loading="lazy">
        </div>
        <div class="work-card-body">
      ...
      <a class="work-card" href="/work/supporting-local-music">
        <div class="work-card-media">
          <img src="/assets/img/joie-de-vivre/jdv-facebook.webp"
               ...
               sizes="(min-width: 1180px) 526px, (min-width: 681px) 50vw, 100vw" alt="The Joie de Vivre poster art" width="3840" height="2010" loading="lazy">
        </div>
        <div class="work-card-body">
